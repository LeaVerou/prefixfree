...
"@"+f+"$1")));return a=a.replace(RegExp("-"+f,"g"),"-")},process:{link:function(a){if(/\bstylesheet\b/i.test(a.rel)){var d=a.getAttribute("href")||a.getAttribute("data-href"),c=d.replace(/[^\/]+$/,""),f=a.parentNode,e=new XMLHttpRequest;e.open("GET",d);e.onreadystatechange=function(){if(e.readyState===4){var d=e.responseText;if(d){var d=b.prefixCSS(d,true),d=d.replace(/url\((?:'|")?(.+?)(?:'|")?\)/gi,function(b,a){return!/^[a-z]{3,10}:/i.test(a)?'url("'+c+a+'")':b}),j=document.createElement("style");
